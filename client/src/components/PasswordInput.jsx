  ...
  return (
    <div className="mb-4 relative">
      ...
      <input
        ...
        required={required}
        className="w-full pl-10 pr-10 py-2 border rounded focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-gray-800 dark:text-white dark:border-gray-600"
      />
      <button
        type="button"
