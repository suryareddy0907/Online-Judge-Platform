  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-60 backdrop-blur-sm">
      <div className="relative w-full max-w-md p-8 m-4 bg-[#232b3a] rounded-2xl border-2 border-[#00cfff] shadow-2xl text-white font-mono">
        ...
        <h2 className="text-2xl font-bold text-center mb-1 tracking-wide">Change Password</h2>
        <p className="text-center text-gray-400 mb-4 italic text-xs">Update your password below.</p>
        <form
        ...
        >
          ...
          {/* Error Message */}
          {error && (
            <div className="bg-red-600/20 border border-red-500 text-red-400 px-3 py-2 rounded-md text-xs">
              <div className="flex">
          ...
          {/* Success Message */}
          {success && (
            <div className="bg-green-600/20 border border-green-500 text-green-400 px-3 py-2 rounded-md text-xs">
              <div className="flex">
          ...
          <div className="flex flex-col sm:flex-row gap-2 sm:gap-3 pt-3 sm:pt-4">
            <button
              type="button"
              onClick={onClose}
              className="flex-1 px-3 py-2 border border-gray-300 rounded-md text-xs sm:text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-pink-500"
            >
              Cancel
            </button>
            <button
