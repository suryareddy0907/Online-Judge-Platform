...
const ForgotPassword = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#181c24] font-mono p-4">
      <div className="w-full max-w-md bg-[#232b3a] p-8 rounded-xl border-2 border-[#00cfff] shadow-2xl">
        <h2 className="text-3xl font-extrabold text-center bg-gradient-to-r from-[#00ff99] to-[#00cfff] text-transparent bg-clip-text mb-6">
          Forgot Password
        </h2>
