      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="mb-8 flex flex-wrap gap-4 items-end">
          <input
            ...
            className="border-2 border-[#00cfff] rounded-md px-4 py-2 focus:outline-none focus:ring-2 focus:ring-[#00ff99] bg-[#232b3a] text-white placeholder-[#baffea] font-mono shadow-inner"
